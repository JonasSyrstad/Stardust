...
namespace Fonlow.WebApiClientGen
{
    ...
    public class CodeGenController : ApiController
    {
        ...
        {
            if (parameters == null) parameters = new CodeGenParameters { CamelCase = true, ClientLibraryProjectFolderName = "c:\\temp\\stardustjs\\", GenerateBothAsyncAndSync = true, TypeScriptFolder = "c:\\temp\\stardustjs\\ts\\" };// throw new HttpResponseException(new HttpResponseMessage(HttpStatusCode.BadRequest) { ReasonPhrase = "parametersNull" });
