...
Import-Module $ScriptDir\Bin\Debug\Stardust.Core.Automation.dll
[string]$environment=$host.UI.ReadLine()
$buildSucceeded = Invoke-MsBuild -Path:"C:\Private projects\Eazyport\Main\Src\Pas.PortAgency.Services\Pas.PortAgency.Services.sln"  -ShowBuildWindow
